...
:: Default gRPC tag
set DEFAULT_TAG=v1.50.0

:: Default UE Path
SET DEFAULT_UE_ROOT=Z:\UnrealEngine\

:: User Specific Variables ###############################################################

set /p TAG="Enter gRPC Tag (v1.50.1): "

set /p UE_ROOT="Enter path to Unreal Engine (Z:\UnrealEngine\): "
