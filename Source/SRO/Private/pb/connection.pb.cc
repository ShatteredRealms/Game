...
constexpr ConnectGameServerRequest::ConnectGameServerRequest(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : character_id_(uint64_t{0u}){}
struct ConnectGameServerRequestDefaultTypeInternal {
  constexpr ConnectGameServerRequestDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~ConnectGameServerRequestDefaultTypeInternal() {}
  union {
    ConnectGameServerRequest _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ConnectGameServerRequestDefaultTypeInternal _ConnectGameServerRequest_default_instance_;
...
const uint32_t TableStruct_connection_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::sro::gamebackend::ConnectGameServerRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::sro::gamebackend::ConnectGameServerRequest, character_id_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::sro::gamebackend::ConnectGameServerRequest)},
  { 7, -1, -1, sizeof(::sro::gamebackend::ConnectGameServerResponse)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::sro::gamebackend::_ConnectGameServerRequest_default_instance_),
...
const char descriptor_table_protodef_connection_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020connection.proto\022\017sro.gamebackend\032\034goo"
  "gle/api/annotations.proto\"0\n\030ConnectGame"
  "ServerRequest\022\024\n\014character_id\030\001 \001(\004\":\n\031C"
  "onnectGameServerResponse\022\017\n\007address\030\001 \001("
  "\t\022\014\n\004port\030\002 \001(\r2\244\001\n\021ConnectionService\022\216\001"
  "\n\021ConnectGameServer\022).sro.gamebackend.Co"
  "nnectGameServerRequest\032*.sro.gamebackend"
  ".ConnectGameServerResponse\"\"\202\323\344\223\002\034\022\032/v1/"
  "connect/{character_id}B\010Z\006pkg/pbb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_connection_2eproto = {
  false, false, 360, descriptor_table_protodef_connection_2eproto, "connection.proto", 
  &descriptor_table_connection_2eproto_once, descriptor_table_connection_2eproto_deps, 1, 2,
...
class ConnectGameServerRequest::_Internal {
 public:
};

ConnectGameServerRequest::ConnectGameServerRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:sro.gamebackend.ConnectGameServerRequest)
}
ConnectGameServerRequest::ConnectGameServerRequest(const ConnectGameServerRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  character_id_ = from.character_id_;
  // @@protoc_insertion_point(copy_constructor:sro.gamebackend.ConnectGameServerRequest)
}

inline void ConnectGameServerRequest::SharedCtor() {
character_id_ = uint64_t{0u};
}

ConnectGameServerRequest::~ConnectGameServerRequest() {
  // @@protoc_insertion_point(destructor:sro.gamebackend.ConnectGameServerRequest)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void ConnectGameServerRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void ConnectGameServerRequest::ArenaDtor(void* object) {
  ConnectGameServerRequest* _this = reinterpret_cast< ConnectGameServerRequest* >(object);
  (void)_this;
}
void ConnectGameServerRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ConnectGameServerRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void ConnectGameServerRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:sro.gamebackend.ConnectGameServerRequest)
...
const char* ConnectGameServerRequest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
uint8_t* ConnectGameServerRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:sro.gamebackend.ConnectGameServerRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sro.gamebackend.ConnectGameServerRequest)
  return target;
}

size_t ConnectGameServerRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:sro.gamebackend.ConnectGameServerRequest)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ConnectGameServerRequest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    ConnectGameServerRequest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ConnectGameServerRequest::GetClassData() const { return &_class_data_; }

void ConnectGameServerRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ConnectGameServerRequest *>(to)->MergeFrom(
      static_cast<const ConnectGameServerRequest &>(from));
}


void ConnectGameServerRequest::MergeFrom(const ConnectGameServerRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:sro.gamebackend.ConnectGameServerRequest)
...
void ConnectGameServerRequest::CopyFrom(const ConnectGameServerRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:sro.gamebackend.ConnectGameServerRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ConnectGameServerRequest::IsInitialized() const {
  return true;
}

void ConnectGameServerRequest::InternalSwap(ConnectGameServerRequest* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(character_id_, other->character_id_);
}

::PROTOBUF_NAMESPACE_ID::Metadata ConnectGameServerRequest::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::sro::gamebackend::ConnectGameServerRequest* Arena::CreateMaybeMessage< ::sro::gamebackend::ConnectGameServerRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::sro::gamebackend::ConnectGameServerRequest >(arena);
}
