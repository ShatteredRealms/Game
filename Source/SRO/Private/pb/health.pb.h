...
PROTOBUF_NAMESPACE_OPEN
template<> ::sro::accounts::HealthMessage* Arena::CreateMaybeMessage<::sro::accounts::HealthMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace sro {
namespace accounts {
...
class HealthMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sro.accounts.HealthMessage) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "sro.accounts.HealthMessage";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:sro.accounts.HealthMessage)
 private:
  class _Internal;
...
inline const std::string& HealthMessage::status() const {
  // @@protoc_insertion_point(field_get:sro.accounts.HealthMessage.status)
...
void HealthMessage::set_status(ArgT0&& arg0, ArgT... args) {
 ...
 status_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:sro.accounts.HealthMessage.status)
}
inline std::string* HealthMessage::mutable_status() {
  std::string* _s = _internal_mutable_status();
  // @@protoc_insertion_point(field_mutable:sro.accounts.HealthMessage.status)
  return _s;
}
...
inline std::string* HealthMessage::release_status() {
  // @@protoc_insertion_point(field_release:sro.accounts.HealthMessage.status)
...
inline void HealthMessage::set_allocated_status(std::string* status) {
  ...
  // @@protoc_insertion_point(field_set_allocated:sro.accounts.HealthMessage.status)
}
