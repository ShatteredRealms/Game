...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Get Header Claims", Keywords = "JWT"), Category = "JWT")
	static TMap<FString, FString> GetHeaderClaims(const FString& JWTToken);
	...
	static UJWTVerifier* CreateVerifier(const FString& Key, FString Algorithm);
