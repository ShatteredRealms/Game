...
const uint32_t TableStruct_health_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::sro::HealthMessage, status_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::sro::_HealthMessage_default_instance_),
};

const char descriptor_table_protodef_health_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014health.proto\022\003sro\032\034google/api/annotati"
  "ons.proto\032\033google/protobuf/empty.proto\"\037"
  "\n\rHealthMessage\022\016\n\006status\030\001 \001(\t2Y\n\rHealt"
  "hService\022H\n\006Health\022\026.google.protobuf.Emp"
  "ty\032\022.sro.HealthMessage\"\022\202\323\344\223\002\014\022\n/v1/heal"
  "thB\010Z\006pkg/pbb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_health_2eproto = {
  false, false, 220, descriptor_table_protodef_health_2eproto, "health.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "sro.HealthMessage.status"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
template<> PROTOBUF_NOINLINE ::sro::HealthMessage* Arena::CreateMaybeMessage< ::sro::HealthMessage >(Arena* arena) {
